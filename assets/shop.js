	...
	jQuery(function($){
		$(document.body).on('click', '.quick_view_btn', function(e) {
			...
			$.getJSON( $(this).attr( 'href' ) + '.js', function( product ) {
				...
				$.getScript( "//jk-testshop.myshopify.com/cdn/shopifycloud/shopify/assets/themes_support/option_selection-6f7ad633c5e28837fa6ad78e9835b04d09b5c5c072403701d8bffc9180e7fec7.js", function() {
